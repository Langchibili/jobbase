              ...
              <div className="card-body">
                <div className="media align-items-center">
                  ...
                  <div className="media-body text-end">
                    <p className="fs-18 text-white mb-2">Interviews Schedule</p>
            ...
            <div className="card bg-info">
              <div className="card-body">
                <div className="media align-items-center">
                  ...
                  <div className="media-body text-end">
                    <p className="fs-18 text-white mb-2">Application Sent</p>
            ...
            <div className="card bg-success">
              <div className="card-body">
                <div className="media align-items-center">
                  ...
                  <div className="media-body text-end">
                    <p className="fs-18 text-white mb-2">Profile Viewed</p>
